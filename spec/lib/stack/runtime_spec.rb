...
RSpec.describe Stack::Runtime do
  describe "#call" do
    it "raises an error when out of gas" do
      ...
      instruction = Stack::Instruction.new(60, 0o4)

      expect { runtime.call(instruction) }
        .to raise_error Stack::Runtime::OutOfGas
    end
    ...
    it "adds executed instructions to the context" do
      ...
      expect(runtime.history).to eq({0 => Stack::Instruction.new(60, 0o4)})
    end
  end
end
